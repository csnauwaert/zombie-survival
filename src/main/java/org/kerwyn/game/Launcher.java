...
//		}
	...
	protected static class ApplicationSecurity extends
		...
		protected void configure(HttpSecurity http) throws Exception {
			...
			//This ensure that we can logout using a GET request on page /logout, should be changed
			//to prevent some security issue where another user can disconnect current user
			//The correct way to do it would be by performing a POST request via a form or js
